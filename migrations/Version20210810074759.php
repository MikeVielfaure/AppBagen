 ...
 */
final class Version20210810074759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, idutilisateur_id INT NOT NULL, intitule VARCHAR(255) DEFAULT NULL, datecreation DATE NOT NULL, datecloture DATE DEFAULT NULL, INDEX IDX_CFF65260EAF07004 (idutilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
